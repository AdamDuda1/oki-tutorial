...
export const taskValidator = vine.create({
  ...
  szkopulContest: vine.string().trim().optional().nullable(),
  szkopulPiId: vine.number().positive().optional().nullable(),
  szkopulShortName: vine.string().trim().optional().nullable(),
