...
This is an website proposal for OKI's (Polish _olympiad-oriented computer science club_) tutorial, a website that collects all the materials created by and used by OKI in a nice course format :))
